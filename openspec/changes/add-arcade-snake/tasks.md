...
- [x] 5.3 Perf + regression pass: draw calls via `__glInfo` (expect net reduction, budget <180), production build green, fallback page unchanged; update CREDITS/README only if needed
